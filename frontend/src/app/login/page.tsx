          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-600 rounded-lg">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-3 py-3 px-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-slate-700 font-medium transition-all duration-300">
